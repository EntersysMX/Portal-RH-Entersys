  ...
  return (
    <div className="w-full rounded-xl border border-gray-200 bg-gray-50 overflow-hidden">
      <div className="border-b border-gray-200 bg-white px-3 py-2">
        <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Vista previa sidebar</p>
      </div>

      <div className="p-2">
        {/* Logo area */}
        <div className="flex items-center gap-2 rounded-lg bg-white px-3 py-2 mb-2">
        ...
        {orderedEnabled.length === 0 && (
          <p className={clsx('px-2 py-4 text-center text-xs text-gray-400')}>
